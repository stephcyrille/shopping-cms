...
class AddColor extends React.Component {
  constructor(props){
    super(props)
    document.title = 'Ajouter une couleur | Afro Yaca Drum'
  ...
  postToApi(form_base_url, data){
    ...
    .file_axios.post(`${form_base_url}`, data)
      .then((response) => {
          ...
          this.props.dispatch(push(`${urls.COLOR}`, { snack_open: true }));
        }
      )
      .catch((error) =>{
  ...
  _goToColor(){
    this.props.dispatch(push(`${urls.COLOR}`))
  }
      ...
      <div>
        ...
        <section className="container">
          <Paper className={classes.paper}>
            <h2 style={{ paddingLeft: 20 }}>Ajouter une couleur</h2>
            <hr />
            <form className={`${classes.form}`} noValidate autoComplete="off" onSubmit={ this._handleOnSubmit.bind(this) }>
              <div className={`${classes.row} row`}>
                ...
                <div className="col-4" style={{ paddingLeft: 0, marginTop: 20 }}>
                  <label style={{ paddingLeft: 15, marginBottom: 0 }}>Motif couleur*</label>
                  {
              ...
              <div className={`${classes.row} row`}>
                <div className={`${classes.button_box} mr-auto mx-auto`}>
                  ...
                  <Button 
                    variant="contained"
                    onClick={ this._goToColor.bind(this) }
                  >
                    Annuler
                  </Button>
                </div>
