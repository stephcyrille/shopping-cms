...
class AddCatalogue extends React.Component {
  constructor(props){
    super(props)
    document.title = 'Ajouter un catalogue | Afro Yaca Drum'
            ...
            <form className={`${classes.form}`} noValidate autoComplete="off" onSubmit={ this._handleOnSubmit.bind(this) }>
              <div className={`${classes.row} row`}>
                ...
                <div className="col-4" style={{ paddingLeft: 0, marginTop: 20 }}>
                  <label style={{ paddingLeft: 15, marginBottom: 0 }}>Photo du catalogue*</label>
                  {
              ...
              <div className={`${classes.row} row`}>
                <div className={`${classes.button_box} mr-auto mx-auto`}>
                  ...
                  <Button 
                    variant="contained"
                    onClick={ this._goToCatalogue.bind(this) }
                  >
                    Annuler
                  </Button>
                </div>
